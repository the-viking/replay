...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.invisible'
        db.delete_column(u'exchange_item', 'invisible')

        # Adding field 'Item.appears'
        db.add_column(u'exchange_item', 'appears',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.invisible'
        db.add_column(u'exchange_item', 'invisible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Item.appears'
        db.delete_column(u'exchange_item', 'appears')
    ...
    models = {
        ...
        u'exchange.item': {
            ...
            'appears': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
