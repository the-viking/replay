...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'admin_extension_profile', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.telephone'
        db.alter_column(u'admin_extension_profile', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
