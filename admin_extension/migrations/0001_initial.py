...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Info'
        db.create_table(u'admin_extension_info', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=2000)),
        ))
        db.send_create_signal(u'admin_extension', ['Info'])

        # Adding model 'Profile'
        db.create_table(u'admin_extension_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('picture', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('telephone', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
        ))
        db.send_create_signal(u'admin_extension', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Info'
        db.delete_table(u'admin_extension_info')

        # Deleting model 'Profile'
        db.delete_table(u'admin_extension_profile')


    models = {
        u'admin_extension.info': {
            'Meta': {'object_name': 'Info'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'text': ('django.db.models.fields.TextField', [], {'max_length': '2000'})
        },
        u'admin_extension.profile': {
